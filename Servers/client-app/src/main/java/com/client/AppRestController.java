...
public class AppRestController {
    ...
    @RequestMapping(value = "/login-LKApp", method=RequestMethod.GET)
    public RedirectView processForm1() {
        RedirectView redirectView = new RedirectView();
        redirectView.setUrl("http://localhost:8081/auth/oauth/authorize?response_type=code&client_id=1231231234&redirect_url=http://localhost:9999/oauth/access?key=value&scope=user_read%20user_write");
        return redirectView;
    }
